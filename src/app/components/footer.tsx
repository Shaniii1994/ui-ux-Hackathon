...
const Footer: React.FC<FooterProps> = () => {
  return (
    <footer className="bg-white-900 text-black p-8 bg-gray-50">
      <div className="container mx-auto">
        ...
        <div className="text-center mt-4 bg-purple-50">
          <p className="text-gray-500 ">&copy; Wobeky. All Rights Reserved</p>
