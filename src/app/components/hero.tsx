...
const slides = [
  {
    ...
    description:
      "Unleash Your Imagination, One Piece at a Time.",
    buttonText: "Shop Now",
    chairImage: "/2.png", // Replace with the correct path
    lampImage: "/1.png", // Replace with the correct path
  },
  {
    ...
    buttonText: "Shop Now",
    chairImage: "/3.png", // Replace with another chair image
    lampImage: "/1.png", // Replace with another lamp image
  },
  {
    ...
    buttonText: "Shop Now",
    chairImage: "/4.png", // Replace with another chair image
    lampImage: "/1.png", // Replace with another lamp image
  },
];
  ...
  return (
    <section className="relative bg-purple-50 py-10 md:py-20 px-5 md:px-20 flex flex-col md:flex-row items-center justify-between overflow-hidden">
      ...
      <div className="md:w-1/3 max-w-lg text-center md:text-left flex flex-col justify-center">
        ...
        <h1 className="text-4xl md:text-4xl font-bold text-indigo-950 leading-tight mt-2">
          {current.title}
        </h1>
      ...
      <div className="md:w-1/3 flex justify-center items-center relative">
        <div className="relative bg-gradient-to-r from-pink-100 to-purple-200 rounded-full p-10 shadow-xl mt-10 mx-auto">
         ...
         {/* "Discount Badge" */}
       <div className="absolute top-10 right-5 bg-gradient-to-r from-blue-400 to-blue-600 text-white text-xl font-bold py-2 px-4 rounded-full">
        {'50% OFF'} 
        </div>
