  ...
  return (
    <div className='flex justify-around items-center h-[44px] bg-violet-600'>
        <div className='flex gap-10' >
            <div className='flex gap-2 items-center font-semibold text-white text-[16px]'><MdMailOutline className='text-lg'/>mhhasanul@gmail.com</div>
            <div className='flex gap-2 items-center font-semibold text-white text-[16px]'> <FaPhoneAlt />(12345)67890</div>
        </div>
    ...
    <div className=''>
        <ul className='flex items-center text-white gap-4 text-[16px] font-semibold'>
            ...
            <Link href={'/'}><li className='flex items-center gap-1'>Login <MdAccountCircle className='text-lg' /></li></Link>
