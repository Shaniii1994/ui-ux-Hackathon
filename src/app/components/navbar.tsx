            ...
            <div className="h-[50px] w-full bg-[#7E33E0] flex items-center justify-between px-4 sm:px-8 md:px-16 lg:px-32 xl:px-48 space-x-4">
                ...
                <div className="flex items-center space-x-4">
                    ...
                    <div className="flex items-center space-x-2">
                        ...
                        <span className="hidden sm:inline text-white font-[Josefin Sans] font-semibold text-sm md:text-base hover:text-pink-400">
                ...
                <div className="flex items-center space-x-4">
                    ...
                    <div className="hidden sm:flex items-center space-x-1">
                        <span className="text-[#F1F1F1] font-[Josefin Sans] font-semibold text-sm md:text-base hover:text-pink-400">
                            English
                        </span>
                        <RiArrowDropDownLine className="w-4 h-4 text-white hover:text-pink-400" />
                    </div>
                    ...
                    <div className="flex items-center space-x-1">
                        <span className="hidden sm:inline text-[#F1F1F1] font-[Josefin Sans] font-semibold text-sm md:text-base hover:text-pink-400">
                            Login
                        </span>
                        <FiUser className="w-4 h-4 text-white hover:text-pink-400" />
                    </div>
                    ...
                    <div className="flex items-center space-x-1">
                        ...
                        <CiHeart className="w-4 h-4 text-white hover:text-pink-400" />
                    </div>

                    {/* Cart Icon */}
                    <FiShoppingCart className="w-5 h-5 text-white hover:text-pink-400" />
                </div>
            </div>
...
Contact
                ...
                <div className="flex items-center ml-auto">
                    ...
                    <div className="w-[40px] h-[40px] bg-[#FB2E86] flex items-center justify-center rounded-r">
                        <CiSearch className="w-5 h-5 text-white hover:text-pink-400" />
                    </div>
                </div>
            </div>
        </div>
